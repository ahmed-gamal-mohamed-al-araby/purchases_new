...
{{-- Custom Title --}}
@section('title')
@lang('site.Add') @lang('site.business_nature')
@endsection
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <h1> @lang('site.add_business_nature')</h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('businessNature.index') }}">
                ...
                <div class="form-layout mb-3">
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <h5>@lang('site.info_business_nature')</h5>
                        </div>
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("businessNature.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">
                                                    @lang("site.business_nature_name") @lang("site.en")
                                                </label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">
                                                    @lang("site.business_nature_name") @lang("site.ar")
                                                </label>
