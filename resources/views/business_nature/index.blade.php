            ...
            <div class="col-12">
                <div class="row mb-3">
                    <div class="col-12 d-flex justify-content-between">
                        <a href="{{ route('businessNature.create') }}" class="btn btn-success header-btn ">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr style="text-align:center;">
                                    <th> @lang('site.id')</th>
                                    <th> @lang('site.business_nature_name') @lang('site.en') </th>
                                    <th> @lang('site.business_nature_name') @lang('site.ar') </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{$businessNature->name_en}}</td>
                                    <td>{{$businessNature->name_ar}}</td>
                                    <td>{{$businessNature->item->name_ar}}</td>

                                    <td>
                                        {{-- <a href="{{route("businessNature.edit",$businessNature->id)}}" class="btn btn-sm btn-info">
                                        <i class="fa fa-eye"></i>
                                        </a> --}}
                                        <a href="{{route("businessNature.edit",$businessNature->id)}}" class="btn btn-sm btn-success">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <!-- <a href="{{route("businessNature.delete",$businessNature->id)}}" class="btn btn-sm btn-danger">
