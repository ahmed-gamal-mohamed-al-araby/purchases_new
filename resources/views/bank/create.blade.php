                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("bank.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-control" id="">
                                                @error('bank_name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="currency" value="{{ old('currency') }}" class="form-control" id="">
                                                @error('currency')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="bank_code" value="{{ old('bank_code') }}" class="form-control" id="">
                                                @error('bank_code')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="bank_account_number" value="{{ old('bank_account_number') }}" class="form-control" id="">
