                                            ...
                                            <form action="{{ route('invoice.store') }}" method="post"
                                                ...
                                                <div class="tab">
                                                    <div class="row row-page">
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="input-group mb-3">
                                                                <input type="hidden" name="business_nature" class="businessID">
                                                                <select name="business_nature"
                                                                    class="form-control zero business_nature" id="">
                                                                    <option value=""></option>
                                                                    @foreach ($businessNatures as $businessNature )
                                                                    <option value="{{$businessNature->id}}">{{$businessNature['name_'.$currentLanguage]}}</option>
                                                                    @endforeach
                                                                </select>

                                                                <input type="text" name="" class="form-control  not_zero business_nature"
                                                                    readonly id="" placeholder="@lang("site.business_nature")">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="" class="form-control project_type"
                                                                    readonly id="" placeholder="@lang("site.project_type")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="covenant_type"
                                                                class="form-control require covenant_type" id="">
                                                                <option value=""></option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="detection_number"
                                                                    class="form-control detection_number" id=""
                                                                    placeholder="@lang("site.detection_number")">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    <input type="text" name=""
                                                                        class="form-control supplier_name" readonly
                                                                        id="" placeholder="@lang("site.name_supplier")">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    <input type="text" name="supply_order_number"
                                                                        class="form-control  supply_order_number"
                                                                        id="" placeholder="@lang("site.supply_order_number")">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group mb-3">
                                                                    <input type="text" onfocus="(this.type='date')" name="invoice_date"
                                                                        class="form-control  require invoice_date" id=""
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <textarea class="form-control product"
                                                                        name="product"
                                                                        placeholder=" @lang('site.product')"></textarea>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="tab">
                                                    <div class="row row-page supplier-accepted">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="unit_price"
                                                                    class="form-control require unit_price" id=""
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text"  value="1" name="unit_quantity"
                                                                    class="form-control unit_quantity" id=""
                                                                    placeholder="@lang("site.unit_quantity")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="total" readonly style="color: #000"
                                                                    class="form-control total" id="" placeholder="@lang("site.total")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="restrained_type"
                                                                    class="form-control restrained_type" id="">
                                                                    <option value=""></option>
                                                    ...
                                                    <div id="without">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="value_tax_rate"
                                                                    class="form-control value_tax_rate" id="">
                                                                    <option value=""></option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="value_tax" readonly
                                                                    class="form-control value_tax" id=""
                                                                    placeholder="@lang("site.value_tax")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="overall_total" readonly
                                                                    class="form-control overall_total" id=""
                                                                    placeholder="@lang("site.overall_total")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="other_discount" value="0"
                                                                    class="form-control other_discount" id=""
                                                                    placeholder="@lang("site.other_discount")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="total_after_discount" readonly
                                                                    class="form-control total_after_discount" id=""
                                                                    placeholder="@lang("site.total_after_discount")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="expense_type"
                                                                    class="form-control expense_type" id="">
                                                                    <option value=""></option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="tax_deduction"
                                                                    class="form-control tax_deduction" id="">
                                                                    <option value=""></option>
                                                                    ...
                                                                    <option value="6">دفعات مقدمه</option>
                                                                </select>
                                                            </div>
                                                            @error('tax_deduction')
                                                                <div class="text-danger">{{ $message }}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="tax_deduction_value"
                                                                    class="form-control tax_deduction_value" id=""
                                                                    placeholder="@lang("site.tax_deduction_value")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="net_total"
                                                                    ...
                                                                    placeholder="@lang("site.net_total")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="discount_type" readonly
                                                                    class="form-control discount_type" placeholder="@lang("site.discount_type")">
                                                            </div>
                                                            @error('discount_type')
                                                                <div class="text-danger">{{ $message }}
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="business_insurance_rate"
                                                                    class="form-control business_insurance_rate" id="">
                                                                    <option value=""></option>
                                                                    <option value="5">5%</option>
                                                                    <option value="10"> 10% </option>
                                                                    <option value="0">0%</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="business_insurance_value" readonly
                                                                    class="form-control business_insurance_value" id=""
                                                                    placeholder="@lang("site.business_insurance_value")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="net_total_after_business_insurance"
                                                                    readonly
                                                                    class="form-control net_total_after_business_insurance"
                                                                    id="" placeholder="@lang("site.net_total_after_business_insurance")">
                                                            </div>
                                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        //                     `<option value="${item.id}">${item.nat_tax_number} - (${item.name_ar})</option>`
        //                 );
        //             });
        //         }
