                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("items.update",$item->id)}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$item->name_en}}" name="name_en" class="form-control" id="">
                                                @error('name_en')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$item->name_ar}}" name="name_ar" class="form-control" id="">
                                                @error('name_ar')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
