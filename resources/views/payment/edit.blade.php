                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">@lang('site.edit_payment')</h3>
                        </div>
                        <main class="checkout">
                            <div class="card-data login-card">
                                <div class="row no-gutters">
                                    <div class="col-12 ">
                                        <div class="card-body">
                                            <form action="{{ route('paymentInvoice.update',$paymentInvoice->id) }}" method="post"
                                                ...
                                                <div class="tab">
                                                    ...
                                                    {{-- order_number --}}
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="order_number"
                                                                    class="form-control " id="" value="{{ $paymentInvoice->order_number}}"
                                                                ...
                                                                <select name="item_id" class="form-control require item_id"
                                                                    ...
                                                                    <option value="">@lang("site.choose")
                                                                        ...
                                                                        @foreach ($items as $item)
                                                                            <option value="{{ $item->id }}" @if ($paymentInvoice->item_id == $item->id)
                                                                                selected
                                                                            @endif > {{ $item['name_' . $currentLanguage] }}</option>
                                                                        @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <select name="project_id"
                                                                    class="form-control project_code" id="">
                                                                    <option value="">@lang("site.choose")
                                                                        @lang("site.project_code")</option>
                                                                        @foreach ($projects as $project)
                                                                        <option value="{{ $project->id }}" @if ($paymentInvoice->project_id == $project->id)
                                                                            selected
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="" value=" {{$paymentInvoice->project['name_'.$currentLanguage]}} " class="form-control project_name"
                                                                    readonly id="" placeholder="@lang("site.name_project")">
                                                                 @else
                                                                 <input type="text" name="" value="" class="form-control project_name"
                                                                    readonly id="" placeholder="@lang("site.name_project")">
                                                                 @endif
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3">
                                                            <select name="supplier_type"
                                                                ...
                                                                <option value="company" @if ($paymentInvoice->supplier->type == "company")
                                                                        selected
                                                                @endif>شركه
                                                                </option>
                                                                <option value="person" @if ($paymentInvoice->supplier->type == "person")
                                                                    selected
                                                            @endif>فرد</option>
                                                                <option value="import" @if ($paymentInvoice->supplier->type == "import")
                                                                    selected
                                                            @endif>استيراد
                                                                </option>
                                                                <option value="without" @if ($paymentInvoice->supplier->type == "without")
                                                                    selected
                                                            @endif>بدون
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3">
                                                            <select name="nat_tax_number"
                                                                ...
                                                                <option value="{{$supplier->id}}" @if ($supplier->id == $paymentInvoice->supplier->id)
                                                                    selected
                                                                @endif >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3">
                                                            <input type="text" name="" value="{{ $paymentInvoice->supplier['name_' . $currentLanguage] }}" class="form-control supplier_name" readonly id="" placeholder="@lang(" site.name_supplier")">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="invoice_number"
                                                                    class="form-control  invoice_number" value="{{$paymentInvoice->invoice_number}}"
                                                                    id="" placeholder="@lang("site.invoice_number")">
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="input-group mb-3">
                                                                        <select name="payment_method"
                                                                            class="form-control require payment_method"
                                                                            id="">
                                                                            <option value=""></option>
                                                                            <option value="cashe" @if ($paymentInvoice->payment_method == "cashe")
                                                                                selected
                                                                            @endif>نقدي</option>
                                                                            <option value="cheque" @if ($paymentInvoice->payment_method == "cheque")
                                                                                selected
                                                                            @endif>شيك</option>
                                                                            <option value="bank_transfer" @if ($paymentInvoice->payment_method == "bank_transfer")
                                                                                selected
                                                                            @endif> تحويل بنكي </option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="input-group mb-3">
                                                                        <input type="text" onfocus="(this.type='date')" name="date_payment" value="{{$paymentInvoice->date_payment}}"
                                                                 ...
                                                                 {{-- Bank Name --}}
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <select name="bank_id" class="form-control bank_child require bank"
                                                                                id="">
                                                                                <option value="">@lang("site.choose")
                                                                                    @lang("site.bank")</option>
                                                                                @foreach ($banks as $bank)
                                                                                    <option value="{{ $bank->id }}" @if ($paymentInvoice->bank_id == $bank->id )
                                                                                            selected
                                                                                    @endif>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <input type="text" readonly name="" value="@if($paymentInvoice->bank){{$paymentInvoice->bank->currency}}@endif"
                                                                                class="form-control bank_child require currency"
                                                                                id="" placeholder="@lang("site.currency")">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <input type="number" name="exchange_rate" value="{{$paymentInvoice->exchange_rate}}"
                                                                                class="form-control require  bank_child exchange_rate"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <input type="text" name="cheque_number" value="{{$paymentInvoice->cheque_number}}"
                                                                                class="form-control require @if ($paymentInvoice->payment_method  !== "cheque")
                                                                                cheque_number
                                                                         @endif cheque_child  "
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group mb-3">
                                                                            <input type="number" name="cheque_value" value="{{$paymentInvoice->value}}"
                                                                                class="form-control  require  "
                                                                                id="" placeholder="@lang("site.value_payment")">
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        {{-- <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" onfocus="(this.type='date')" name="delivery_date"
                                                                    class="form-control" value="{{$paymentInvoice->date_delivery}}" id=""
                                                        ...
                                                        {{-- <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="recipient_name"
                                                                    class="form-control" value="{{$paymentInvoice->recipient_name}}"
                                                ...
                                                <input type="file" id="myfile" name="myfile">
                                                        ...
                                                        @if($paymentInvoice->file_name)

                                                        <a class="btn btn-success mb-3" href="{{ asset("uploads/$paymentInvoice->file_name") }}" target="_blank">{{$paymentInvoice->original_name}}</a>
                                                       @endif --}}
                                                                   {{-- Notes --}}
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <textarea class="form-control " name="notes"
                                                                    placeholder=" @lang('site.notes')">{{$paymentInvoice->notes}}</textarea>
                                                            </div>
                                                        </div>
                                                 ...
                                                 <div class="in_delivery">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" onfocus="(this.type='date')"
                                                                    name="delivery_date_in" value="{{$paymentInvoice->date_delivery_in}}" class="form-control" id=""
                                                                    placeholder="@lang("site.delivery_date")">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="recipient_name_in"
                                                                    class="form-control" id="" value="{{$paymentInvoice->recipient_name_in}}" placeholder="@lang("site.the_recipient_name")">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group mb-3">
                                                                <input type="text" onfocus="(this.type='date')" value="{{$paymentInvoice->date_delivery_out}}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group mb-3">
                                                                <input type="text" name="recipient_name_out" value="{{$paymentInvoice->recipient_name_out}}"
