                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr style="text-align:center;">
                                        <th >  @lang('site.id')</th>
                                        <th >  @lang('site.name_nature_dealing')  @lang('site.en') </th>
                                        <th >  @lang('site.name_nature_dealing')  @lang('site.ar') </th>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$NatureDealing->name_en}}</td>
                                        <td>{{$NatureDealing->name_ar}}</td>
                                        <td>{{$NatureDealing->code}}</td>
                                        <td>{{$NatureDealing->discountTypes['name_'.$currentLanguage]}}</td>
                                        <td>
                                            {{-- <a href="{{route("natureDealing.edit",$NatureDealing->id)}}" class="btn btn-sm btn-info">
                                                <i class="fa fa-eye"></i>
                                            </a> --}}
                                            <a href="{{route("natureDealing.edit",$NatureDealing->id)}}" class="btn btn-sm btn-success">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <!-- <a href="{{route("natureDealing.delete",$NatureDealing->id)}}" class="btn btn-sm btn-danger">
