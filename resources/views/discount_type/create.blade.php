...
{{-- Custom Title --}}
@section('title')
@lang('site.Add') @lang('site.discount_type')
@endsection
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <h1> @lang('site.add_discount_type')</h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('discountType.index') }}">
                            @lang('site.discountTypes')</a>
                    </li>
                    <li class="breadcrumb-item active"> @lang('site.add_discount_type')</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("discountType.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
