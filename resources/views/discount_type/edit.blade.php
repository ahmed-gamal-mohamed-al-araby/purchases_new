...
{{-- Custom Title --}}
@section('title')
@lang('site.edit') @lang('site.discount_type')
@endsection
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("discountType.update",$discountType->id)}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-6">
