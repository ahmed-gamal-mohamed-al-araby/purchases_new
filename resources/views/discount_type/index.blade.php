...
<section class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <h1> @lang('site.discountTypes')</h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}"> @lang('site.Home')</a></li>
                    <li class="breadcrumb-item active"> @lang('site.discountTypes')</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="row mb-3">
                    <div class="col-12 d-flex justify-content-between">
                        <a href="{{ route('discountType.create') }}" class="btn btn-success header-btn ">
                            @lang('site.add_discount_type')</a>
                    </div>
                </div>
                <div class="card">
                    <!-- /.card-header -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr style="text-align:center;">
                                    <th> @lang('site.id')</th>
                                    <th> @lang('site.name_discount_type') @lang('site.en') </th>
                                    <th> @lang('site.name_discount_type') @lang('site.ar') </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{$discountType->name_en}}</td>
                                    <td>{{$discountType->name_ar}}</td>
                                    <td>{{$discountType->code}}</td>
                                    <td>
                                        {{-- <a href="{{route("discountType.edit",$discountType->id)}}" class="btn btn-sm btn-info">
                                        <i class="fa fa-eye"></i>
                                        </a> --}}
                                        <a href="{{route("discountType.edit",$discountType->id)}}" class="btn btn-sm btn-success">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <!-- <a href="{{route("discountType.delete",$discountType->id)}}" class="btn btn-sm btn-danger">
