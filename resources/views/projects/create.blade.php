        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> @lang('site.add_project')</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("projects.store")}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="type" value="{{ old('type') }}" class="form-control" id="">
                                                    ...
                                                    <option value="Excl">غير شامل</option>
                                                </select>
                                                @error('type')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
