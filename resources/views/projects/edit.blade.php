...
{{-- Custom Title --}}
@section('title')
@lang('site.edit') @lang('site.project')
@endsection
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> @lang('site.edit_project')</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="form-layout mb-3">
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <h5>@lang('site.info_project')</h5>
                        </div>
                        <div class="card-body">
                            <div id="items_table" class="table">
                                <form action="{{route("projects.update",$project->id)}}" id="" class="form" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">
                                                    @lang("site.name_project") @lang("site.en")
                                                </label>
                                                <input type="text" value="{{$project->name_en}}" name="name_en" class="form-control" id="">
                                                @error('name_en')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">
                                                    @lang("site.name_project") @lang("site.ar")
                                                </label>
                                                <input type="text" value="{{$project->name_ar}}" name="name_ar" class="form-control" id="">
                                                @error('name_ar')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
